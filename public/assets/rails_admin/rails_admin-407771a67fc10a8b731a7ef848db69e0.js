...
// The value/s can optionally be executed if it's a function
    ...
    jQuery.event = {
        ...
        special: {
            load: {
                // Prevent triggered photos.load events from bubbling to window.load
                noBubble: true
            },
            focus: {
...
(function (factory) {
    ...
    function Datepicker() {
        ...
        this._defaults = { // Global defaults for all the date picker instances
            ...
            buttonImage: "", // URL for trigger button photos
            buttonImageOnly: false, // True if the photos appears alone, false if it appears on a button
    ...
    $.extend(Datepicker.prototype, {
        ...
        _showDatepicker: function (input) {
            ...
            if (input.nodeName.toLowerCase() !== "input") { // find from button/photos trigger
    ...
    $.extend(Timepicker.prototype, {
        ...
        _showTimepicker: function (input) {
            ...
            if (input.nodeName.toLowerCase() != 'input') {
                input = $('input', input.parentNode)[0];
            } // find from button/photos trigger
        ...
        _checkExternalClick: function (event) {
            ...
            if ($target[0].id != $.timepicker._mainDivId &&
                $target.parents('#' + $.timepicker._mainDivId).length == 0 && !$target.hasClass($.timepicker.markerClassName) && !$target.hasClass($.timepicker._triggerClass) &&
